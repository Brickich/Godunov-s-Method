...
Godunov = CDLL("./Godunov/dll/Godunov.dll")
ExactSolution = CDLL("./Exact/dll/ExactSolution.dll")
...
RunDiscontinuitySimulation("cvr-cvr" , N=1000 , 
                           left_border=-0.5 , right_border=0.5, 
                           t_end=0.2, CFL=1.0 , tolerance=1e-15)
